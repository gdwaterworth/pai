...
from paradox.interfaces.mqtt.entities.sensor import PAIStatusSensor, SystemStatusSensor, ZoneStatusSensor
...
class MQTTAutodiscoveryEntityFactory:
    ...
    def make_zone_status_sensor(self, zone, status):
        return ZoneStatusSensor(zone, status, self.device, self.availability_topic)
